# 📰 News Scraper Dashboard# DesiQuant: News Scraper



A Streamlit-based dashboard for scraping and managing Indian financial news articles from 15 major sources.A [scrapy](https://github.com/scrapy/scrapy) crawler that scrapes market news from Indian financial news outlets
...
- **Scrape Articles** from 15 Indian financial news sources

- **View & Search** through scraped articles| Publisher                                                       | Sitemap Type                                                                                     |

- **SQLite Database** for local storage| --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |

- **Clean Interface** built with Streamlit| [News 18](https://www.news18.com)                               | [Daily](https://www.news18.com/commonfeeds/v1/eng/sitemap/daily/2024-09-13.xml)                  |

| [The Hindu](https://www.thehindu.com)                           | [Daily](https://www.thehindu.com/sitemap/archive/all/20240913_1.xml)                             |

## 📰 Supported News Sources| [The Hindu Business Line](https://www.thehindubusinessline.com) | [Daily](https://www.thehindubusinessline.com/sitemap/archive/all/20240913_1.xml)                 |
...
- Economic Times| [Money Control](https://www.moneycontrol.com)                   | [Monthly](https://www.moneycontrol.com/news/sitemap/sitemap-post-2024-07.xml)                    |

- Business Standard| [Business Standard](https://www.business-standard.com)          | [Monthly](https://www.business-standard.com/sitemap/2022-march-1.xml)                            |

- Business Today| [Economic Times](https://economictimes.indiatimes.com)          | [Monthly](https://economictimes.indiatimes.com/etstatic/sitemaps/et/2024-August-1.xm)            |

- Financial Express| [Firstpost](https://www.firstpost.com)                          | [Daily](https://www.firstpost.com/commonfeeds/v1/mfp/sitemap/daily/2015-07-08.xml)               |

- Money Control| [NDTV Profit](https://www.ndtvprofit.com)                       | [Daily](https://www.ndtvprofit.com/sitemap/sitemap-daily-2017-07-08.xml)                         |

- NDTV Profit| [Free Press Journal](https://www.freepressjournal.in)           | [Daily](https://www.freepressjournal.in/sitemap/sitemap-daily-2015-01-07.xml)                    |

- CNBC TV18| [Outlook India](https://www.outlookindia.com)                   | [Daily](https://www.outlookindia.com/sitemap/sitemap-daily-2024-07-08.xml)                       |

- News18| [Zee News](https://zeenews.india.com)                           | [Monthly](https://zeenews.india.com/sitemaps/sitemap-2018-feb.xml)                               |

- Indian Express| [Financial Express](https://www.financialexpress.com)           | [Daily](https://www.financialexpress.com/sitemap.xml?yyyy=2024&mm=07&dd=08)                      |

- The Hindu| [Indian Express](https://indianexpress.com)                     | [Daily](https://indianexpress.com/sitemap.xml?yyyy=2024&mm=07&dd=08)                             |

- The Hindu Business Line| [CNBCTV18](https://cnbctv18.com)                                | [Daily](https://www.cnbctv18.com/commonfeeds/v1/cne/sitemap/daily/2024-07-08.xml)                |

- First Post

- Free Press Journal## Data Usage

- Outlook India

- Zee NewsYou can readily consume the data without setting up any infrastructure. The data is publicly accessible and updated every 1 hour. <u>**The entire data dump is around 5 GB**</u> and increases by ~10 MB everyday.



## 🚀 Quick Start##### Data Files



```bashThe entire consolidated data is accessible at `s3://desiquant/data/news.parquet`

# Install dependencies

pip install -r requirements.txtThe individual news publisher data files are accessible at `s3://desiquant/data/news/cnbctv18.csv`. To view a list of all available publishers you can check out [below](#local-development)



# Run the dashboard##### Pandas Usage
...
## ⚙️ Configurationimport pandas as pd



Edit `news_scraper/settings.py` to customize:df = pd.read_parquet("s3://desiquant/data/news.parquet", storage_options={

- **Date Range**: Change how far back to scrape articles    "key": "sceN1eFOJQmBIWHNEMd8",

- **Scrape Mode**: Choose between "dump" (all articles) or "update" (new only)    "secret": "w1BERx7F6LTe87sk9K9deoBcfYXNCwlol5xcLeev",
...
1. **Start Scraping**: Select news sources and click "Start Scraping"```

2. **View Articles**: Browse scraped articles with filters

3. **Search**: Find specific articles using keywords##### Data Preview
...
MIT LicenseInstall all python dependencies
